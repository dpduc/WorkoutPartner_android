...
object BundledRoutines {
    ...
    private val all: List<Pair<RoutineEntity, List<RoutineStepEntity>>> = listOf(
        RoutineEntity(id = "full_body_basics", name = "Full Body Basics") to listOf(
        ...
        RoutineEntity(id = "lower_body_focus", name = "Lower Body Focus") to listOf(
        ...
        RoutineEntity(id = "quick_upper_body", name = "Quick Upper Body") to listOf(
